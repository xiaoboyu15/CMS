...
<div class="container">
<form action="${pageContext.request.contextPath}/getPowerByUser.do" method="post">
   <h3>用户权限变更</h3>
    <div>
        <select style="border-radius: 10px;width:200px;height:30px;width: auto;padding: 0 2%;margin: 0;" name="select">
            ...
            <option style="text-align:center;" value="reporter" id="reporter">信息录入员</option>
        </select>
    </div>
    <h3>申请权限原因</h3>
    ...
    <div>
        ...
        <button onclick="window.location.href='${pageContext.request.contextPath}/goToUserIndex.do'">返回</button>
    </div>
    </form>
</div>
</body>
